...
class PongWrapper(gym.Env):
    ...
    def __init__(self, env_name: str = "pong", opponent_agent: Any = None):
        ...
        self.opponent = opponent_agent or RandomAgent(self.env.action_space, player_id=1)
...
def main():
    ...
    parser.add_argument("--eval", action="store_true", help="Evaluate a trained agent")
    parser.add_argument(
        "--timesteps",
        type=int,
        default=100_000,
    ...
    parser.add_argument(
        "--model-path", type=str, default="models/dqn_pong", help="Path to save/load model"
    )
